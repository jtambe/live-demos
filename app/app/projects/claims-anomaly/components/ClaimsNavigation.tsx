...
export default function ClaimsNavigation({ activePage }: ClaimsNavigationProps) {
  return (
    <nav className={styles.nav}>
      <Link href="/projects/claims-anomaly/upload" prefetch="auto">
        <button className={`${styles.navButton} ${activePage === 'upload' ? styles.active : ''}`}>
          📤 Upload Claims
        </button>
      </Link>
      <Link href="/projects/claims-anomaly/claims" prefetch="auto">
        <button className={`${styles.navButton} ${activePage === 'claims' ? styles.active : ''}`}>
          📊 View Claims
        </button>
      </Link>
      <Link href="/projects/claims-anomaly/anomalies" prefetch="auto">
        <button className={`${styles.navButton} ${activePage === 'anomalies' ? styles.active : ''}`}>
          🔍 View Anomalies
        </button>
      </Link>
      <Link href="/projects/claims-anomaly/rules" prefetch="auto">
